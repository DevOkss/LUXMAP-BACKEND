...
<template>
    <TcgcAuthLayout title="Welcome Back!" subtitle="Sign in with your student ID to manage your organization's activities.">
        ...
        <form @submit.prevent="submit" class="flex flex-col gap-6">
            <div class="grid gap-2">
                <Label for="student_number" class="text-sm font-semibold text-gray-700">ID Number</Label>
                <Input
                    id="student_number"
                    type="text"
                    required
